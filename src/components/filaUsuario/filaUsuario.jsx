export default function FilaUsuario({ usuario, onEditar }) {
  ...
  //el back retorna bloqueado true/false y activo true/false, uso la variable estado para aclarar eso en el front
  const estado = usuario.bloqueado ? "Bloqueado" : "Activo"; 
